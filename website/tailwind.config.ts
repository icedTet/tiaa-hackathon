  ...
  theme: {
    ...
    extend: {
      animation: {
        ...
        "bounce-mini": "bounce-mini 3s ease-in-out infinite",
        "bounce-linear": "bounce-linear 3s ease-in-out infinite",
        "bounce-opposite-linear":
          "bounce-opposite-linear 3s ease-in-out infinite",
      },
      keyframes: {
        "reverse-spin": {
          from: {
